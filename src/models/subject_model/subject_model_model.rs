...
#[derive(Debug, Deserialize, Serialize, Clone)]
pub struct SubjectTypeModelGet {
    pub id: String,
    pub name: String,
    pub description: Option<String>,
    pub roles: Option<Vec<String>>,
...
#[derive(Debug, Deserialize, Serialize, Clone)]
pub struct SubjectTypeModelNew {
    pub name: String,
    pub description: Option<String>,
    pub roles: Option<Vec<String>>,
}
...
#[derive(Debug, Deserialize, Serialize, Clone)]
pub struct SubjectTypeModelPut {
    pub name: Option<String>,
    pub description: Option<String>,
    pub roles: Option<Vec<String>>,
}

impl SubjectTypeModel {
    pub fn new(class_type: SubjectTypeModelNew) -> Self {
        SubjectTypeModel {
            id: None,
    ...
    pub fn format(class_type: Self) -> SubjectTypeModelGet {
        SubjectTypeModelGet {
    ...
    pub fn put(class_type: SubjectTypeModelPut) -> Document {
